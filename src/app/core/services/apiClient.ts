...
export class APIClient {
     ...
     * @return Success
     */
    login(body: LoginRequestDTO | undefined): Observable<LoginRespondDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<LoginRespondDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<LoginRespondDto>;
        }));
    }

    protected processLogin(response: HttpResponseBase): Observable<LoginRespondDto> {
        ...
        if (status === 200) {
            ...
            result200 = LoginRespondDto.fromJS(resultData200);
     ...
     * @return Success
     */
    addCinema(body: CinemaDTO | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Cinema/addCinema";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddCinema(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddCinema(response_ as any);
                } catch (e) {
    ...
    protected processAddCinema(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    admin(cinemaId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Cinema/{cinemaId}/admin";
        if (cinemaId === undefined || cinemaId === null)
            throw new Error("The parameter 'cinemaId' must be defined.");
        url_ = url_.replace("{cinemaId}", encodeURIComponent("" + cinemaId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAddMovie(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    addUserWithRole(body: UserDTO | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/User/addUserWithRole";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddUserWithRole(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddUserWithRole(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processAddUserWithRole(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAllUsersWithRoles(): Observable<void> {
        let url_ = this.baseUrl + "/api/User/getAllUsersWithRoles";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllUsersWithRoles(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllUsersWithRoles(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processGetAllUsersWithRoles(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    userWithCinema(userId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/UserWithCinema/{userId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUserWithCinema(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUserWithCinema(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUserWithCinema(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAll10(): Observable<UserWithCinemaDTOIEnumerableAPIResponse> {
        let url_ = this.baseUrl + "/api/UserWithCinema/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserWithCinemaDTOIEnumerableAPIResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserWithCinemaDTOIEnumerableAPIResponse>;
        }));
    }

    protected processGetAll10(response: HttpResponseBase): Observable<UserWithCinemaDTOIEnumerableAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserWithCinemaDTOIEnumerableAPIResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getById10(id: number | undefined): Observable<UserWithCinemaDTOAPIResponse> {
        let url_ = this.baseUrl + "/api/UserWithCinema/GetById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserWithCinemaDTOAPIResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserWithCinemaDTOAPIResponse>;
        }));
    }

    protected processGetById10(response: HttpResponseBase): Observable<UserWithCinemaDTOAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserWithCinemaDTOAPIResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    add10(body: UserWithCinemaDTO | undefined): Observable<UserWithCinemaDTOAPIResponse> {
        let url_ = this.baseUrl + "/api/UserWithCinema/Add";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAdd10(response: HttpResponseBase): Observable<UserWithCinemaDTOAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update10(body: UserWithCinemaDTO | undefined): Observable<UserWithCinemaDTOAPIResponse> {
        let url_ = this.baseUrl + "/api/UserWithCinema/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate10(response: HttpResponseBase): Observable<UserWithCinemaDTOAPIResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    deleteById10(id: number | undefined): Observable<BooleanAPIResponse> {
        let url_ = this.baseUrl + "/api/UserWithCinema/DeleteById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    delete10(body: UserWithCinemaDTO | undefined): Observable<BooleanAPIResponse> {
        let url_ = this.baseUrl + "/api/UserWithCinema/Delete";
        url_ = url_.replace(/[?&]$/, "");
...
export class LoginRespondDto implements ILoginRespondDto {
    userId?: number;
    name?: string | null;
    email?: string | null;
    roleId?: number;
    ...
    constructor(data?: ILoginRespondDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LoginRespondDto {
        data = typeof data === 'object' ? data : {};
        let result = new LoginRespondDto();
        result.init(data);
        return result;
    }
...
export interface ILoginRespondDto {
    userId?: number;
    name?: string | null;
    email?: string | null;
    roleId?: number;
...
export class UserWithCinemaDTO implements IUserWithCinemaDTO {
    userwithcinemaId?: number;
    userId?: number | null;
    cinemaId?: number | null;

    constructor(data?: IUserWithCinemaDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.userwithcinemaId = _data["userwithcinemaId"] !== undefined ? _data["userwithcinemaId"] : <any>null;
            this.userId = _data["userId"] !== undefined ? _data["userId"] : <any>null;
            this.cinemaId = _data["cinemaId"] !== undefined ? _data["cinemaId"] : <any>null;
        }
    }

    static fromJS(data: any): UserWithCinemaDTO {
        data = typeof data === 'object' ? data : {};
        let result = new UserWithCinemaDTO();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["userwithcinemaId"] = this.userwithcinemaId !== undefined ? this.userwithcinemaId : <any>null;
        data["userId"] = this.userId !== undefined ? this.userId : <any>null;
        data["cinemaId"] = this.cinemaId !== undefined ? this.cinemaId : <any>null;
        return data;
    }
...
export interface IUserWithCinemaDTO {
    userwithcinemaId?: number;
    userId?: number | null;
    cinemaId?: number | null;
}

export class UserWithCinemaDTOAPIResponse implements IUserWithCinemaDTOAPIResponse {
    success?: boolean;
    data?: UserWithCinemaDTO;
    message?: string | null;
    errorMessage?: string | null;

    constructor(data?: IUserWithCinemaDTOAPIResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.success = _data["success"] !== undefined ? _data["success"] : <any>null;
            this.data = _data["data"] ? UserWithCinemaDTO.fromJS(_data["data"]) : <any>null;
            this.message = _data["message"] !== undefined ? _data["message"] : <any>null;
            this.errorMessage = _data["errorMessage"] !== undefined ? _data["errorMessage"] : <any>null;
        }
    }

    static fromJS(data: any): UserWithCinemaDTOAPIResponse {
        data = typeof data === 'object' ? data : {};
        let result = new UserWithCinemaDTOAPIResponse();
        result.init(data);
        return result;
    }
...
export interface IUserWithCinemaDTOAPIResponse {
    success?: boolean;
    data?: UserWithCinemaDTO;
    message?: string | null;
    errorMessage?: string | null;
...
export class UserWithCinemaDTOIEnumerableAPIResponse implements IUserWithCinemaDTOIEnumerableAPIResponse {
    success?: boolean;
    data?: UserWithCinemaDTO[] | null;
    message?: string | null;
    errorMessage?: string | null;

    constructor(data?: IUserWithCinemaDTOIEnumerableAPIResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["data"])) {
                this.data = [] as any;
                for (let item of _data["data"])
                    this.data!.push(UserWithCinemaDTO.fromJS(item));
            }
            else {
                this.data = <any>null;
            }
    ...
    static fromJS(data: any): UserWithCinemaDTOIEnumerableAPIResponse {
        data = typeof data === 'object' ? data : {};
        let result = new UserWithCinemaDTOIEnumerableAPIResponse();
        result.init(data);
        return result;
    }
...
export interface IUserWithCinemaDTOIEnumerableAPIResponse {
    success?: boolean;
    data?: UserWithCinemaDTO[] | null;
    message?: string | null;
    errorMessage?: string | null;
